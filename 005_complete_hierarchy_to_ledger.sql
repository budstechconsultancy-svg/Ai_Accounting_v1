-- Update master_ledgers table to include complete hierarchy up to ledger level
...
CREATE TABLE `master_ledgers` (
  ...
  -- Complete hierarchy from master_hierarchy table (all levels)
  `type_of_business` varchar(255) DEFAULT NULL COMMENT 'From hierarchy: type_of_business_1',
