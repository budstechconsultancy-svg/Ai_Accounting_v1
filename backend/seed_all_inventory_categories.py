"""
Seed ALL Inventory Categories with Groups and Subgroups
This script adds the standard groups and subgroups to every category:
...
def seed_all_inventory_categories():
    """Seed all inventory categories with standard groups and subgroups"""
    
    print("Seeding ALL Inventory Categories with Groups and Subgroups...")
    ...
    print(f"\n{'='*60}")
    print(f"✅ ALL Inventory categories seeded successfully!")
