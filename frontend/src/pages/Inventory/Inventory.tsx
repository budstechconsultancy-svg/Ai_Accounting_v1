...
import StockMassUploadModal from '../../components/StockMassUploadModal';
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
          ...
          <form onSubmit={handleItemSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <button type="submit" className={`form-button disabled:bg-gray-400 ${editingItemId ? 'bg-orange-600 hover:bg-orange-700' : 'bg-orange-600 hover:bg-orange-700'}`} disabled={!hsnValidation && hsn.length > 0 && !(hsnValidation && (hsnValidation.status === 'valid' || hsnValidation.status === 'mismatch'))}>
                ...
                {stockItems.map(item => (
                  <tr key={item.name}>
                    ...
                    <td className="table-cell text-right">
                      <button onClick={() => handleEditItem(item)} className="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 mr-2">
                        Edit
                      </button>
      ...
      <div className="md:col-span-1">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
          ...
          <form onSubmit={handleUnitSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <button type="submit" className={`form-button ${editingUnitId ? 'bg-orange-600 hover:bg-orange-700' : 'bg-orange-600 hover:bg-orange-700'}`}>
      ...
      <div className="md:col-span-1">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <button type="submit" className={`form-button ${editingId ? 'bg-orange-600 hover:bg-orange-700' : 'bg-orange-600 hover:bg-orange-700'}`}>
