/**
 * ============================================================================
 * CUSTOMER PORTAL PAGE (CustomerPortal.tsx)
 * ============================================================================
 * This page provides a customer relationship management interface.
 * Inspired by Zoho Books' customer portal functionality.
 * 
 * FEATURES:
 * - Dashboard with key metrics (outstanding invoices, credits, payments, quotes)
 * - Customer management (add, edit, view customers)
 * - Quotes management
 * - Invoices tracking
 * - Payment history
 * - Sales orders
 * - Timesheets (projects and approvals)
 * - Customer statements
 * - Document management
 * 
 * ARCHITECTURE:
 * - Tab-based navigation (9 tabs)
 * - Each tab has its own content component
 * - Purple/Indigo color scheme
 * - Modal dialogs for adding customers
 * 
 * FOR NEW DEVELOPERS:
 * - Main component: CustomerPortalPage (manages tab state)
 * - Content components: DashboardContent, CustomersContent, etc.
 * - Add new tabs by updating the 'tabs' array and creating a new content component
 */
...
// Define available tabs in the Customer Portal
type CustomerPortalTab = 'DASHBOARD' | 'CUSTOMERS' | 'QUOTES' | 'INVOICES' | 'PAYMENTS' | 'SALES ORDERS' | 'TIMESHEETS' | 'STATEMENTS' | 'DOCUMENTS';

/**
 * CustomerPortalPage - Main component for the Customer Portal
 * Manages tab navigation and renders appropriate content
 */
